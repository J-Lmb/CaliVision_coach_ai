...
const difficulties = [
  {
    ...
    level: "Beginner",
    description:
      "This challenge level is for people who are new to fitness. Receive 3 challenges per day (7:30AM, 12PM, & 5:30PM EST).",
  },
  {
    id: "EXPERIENCED",
    level: "Experienced",
    description:
      "This challenge level is for people who are familiar with workout exercises. Receive 4 challenges per day (7AM, 12PM, 5PM, & 8PM EST).",
  },
  {
    id: "PROFESSIONAL",
    level: "Professional",
    description:
      "This challenge level is for people who are experienced fitness enthusiasts. Receive 5 challenges per day (6AM, 9AM, 12PM, 5PM, & 8PM EST).",
  },
];

type Difficulties = "BEGINNER" | "EXPERIENCED" | "PROFESSIONAL";
